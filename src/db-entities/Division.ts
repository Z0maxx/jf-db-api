...
export const DivisionSchema = defineEntity({
  ...
  properties: {
    ...
    allOutParticipantDivisionCollection: () => p.oneToMany(AllOutParticipantDivision).mappedBy('division'),
    ...
    monthlyParticipantDivisionCollection: () => p.oneToMany(MonthlyParticipantDivision).mappedBy('division'),
